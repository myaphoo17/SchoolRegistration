	...
	<div class="main_contents">
		<div id="sub_content">
			<form action="editUser" method="post" onsubmit="return validatePassword()">
				...
				<div class="row mb-4">
					<div class="col-md-2"></div>
					<label for="email" class="col-md-2 col-form-label">Set New Email</label>
					<div class="col-md-4">
						<input type="email" class="form-control" name="newEmail" value="${user.email}">
							...
							<div class="modal-dialog modal-dialog-centered">
								<div class="modal-content">
									...
									<div class="modal-body">
										<h5 style="color: rgb(127, 209, 131);">Successfully
											Updated!</h5>
									</div>
