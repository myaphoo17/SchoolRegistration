        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="addUser" class="btn btn-primary col-md-2 mb-3" style="background-color: #223d7d; border-color: #223d7d;">
                Add User
            </a>
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${users}" var="user">
                                <tr>
                                    <td><%= counter++ %></td>
                                    <td>${user.email}</td>
                                   <%--  <td><a href="editUser?email=${user.email}" class="btn btn-secondary mb-3 " style="background-color: #223d7d;">Update</a></td> --%>
                                    <td><a href="deleteUser?email=${user.email}" class="btn btn-danger mb-3"  onclick="return confirm('Are you sure you want to delete this user?');">Remove</a></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
